...
return [
    ...
    "public_db" => [
		...
		'username' => 'bookstack_pub',
		'password' => '8G0KCQqft9EPum3yuTkd',
        "charset" => "utf8mb4",
    ],
    ...
    "bookstack_sources" => [
        [
            ...
            "db" => [
                ...
                "port" => 3306,
				'database' => 'bookstack',
				'username' => 'bookstack_r',
				'password' => 'vp92UuK9oiwql8GWnCSF',
                "charset" => "utf8mb4",
            ],
        ],
    ...
    "smtp" => [
		...
		'username' => 'manual@cocos.software',
		'password' => '03vc3j0~51TpbR@0k6',
        "timeout" => 60,
    ],
];
